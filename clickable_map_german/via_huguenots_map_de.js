/**
 * Via Huguenots - Interaktive Karte
 * Skript zur Anzeige einer interaktiven Karte mit klickbaren Markierungen
 */
...
(function() {
    ...
    // Etappendaten (eingebettet, um Sicherheits- und CORS-Probleme zu vermeiden)
    const stages = [
        {
                "id": "1",
    ...
    // Karte direkt mit eingebetteten Daten initialisieren
    initMap(stages);
    ...
    function initMap(stages) {
        ...
        // Anzeigeposition der Markierung berechnen (mit Offset falls erforderlich)
        ...
        // Verbindungslinien für Markierungen mit Offset erstellen
        ...
        stages.forEach((stage) => {
            ...
            // Rechteck für regionale Routen erstellen, Kreis für andere
            ...
            group.addEventListener('click', function() {
                window.location.href = stage.url_de;
            });

            group.addEventListener('mouseenter', function(e) {
                const nameSpan = tooltip.querySelector('.stage-name');
                nameSpan.textContent = stage.name_full_de;
